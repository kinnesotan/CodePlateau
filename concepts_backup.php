...
if(isset($_POST['associate']))
{
	...
	if(mysqli_query($con,"insert into concept_exercise(concept_id,exercise_id) values ($concept_id, $exercise_id)"))
	{
		?>
			<script>alert("The Exercise and Concept have successfully associated");</script>
		<?php		
	}
	else
	{
